...
export const Navigation = () => {
  ...
  return (
    <header
      className={cs(
        styles.container,
        isDisplayingMenu && styles.displayContainer
      )}
    >
      <div className={styles.top_container}>
        ...
        <div className={styles.button_container}>
          <button
            onClick={() => setIsDisplayingMenu(!isDisplayingMenu)}
      ...
      <nav
        className={isDisplayingMenu ? styles.display : styles.hide}
      ...
      >
        <ul>
          ...
          <li
            ...
            onMouseOver={handleDisplayDropdown}
          >
            <p>Projects</p>
            <div
              className={cs(
                styles.dropdown,
                !isDisplayingDropdown && styles.hideDropdown
              )}
            ...
            >
              <ul>
                ...
                {Object.entries(projects).map((name, item) => (
                  <li key={item}>
